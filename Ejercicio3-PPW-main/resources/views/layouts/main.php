	...
	<div id="app" class="container-fluid p-0">
		...
		<nav class="navbar navbar-expand-lg bg-body-tertiary">
		  <div class="container-fluid">
		    <a class="navbar-brand" href="#">blogsito</a>
		    ...
		    <div class="collapse navbar-collapse" id="navbarSupportedContent">
		      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
		        ...
		        <li class="nav-item">
		          <button class="nav-link btn btn-link" type="button" aria-current="page" 
				  onclick="app.view('newPost')">Nueva publicación</button>
		        </li>
		      </ul>
		      <ul class="navbar-nav me-auto mb-2 d-flex">
				  ...
				  onclick="app.views('inisession')" aria-current="page" href="#">Iniciar sesion</button>
		        </li>
